...
const MiniBar = ({ label, value, max, sub, color }) => {
  ...
  return (
    <div className="px-2 py-1.5 hover:bg-gray-50 rounded-lg transition-colors border border-transparent hover:border-gray-100 mb-1">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
            <div>
              <h1 className="text-[20px] md:text-[26px] font-bold text-gray-900 tracking-tight">
                Placement <span className="text-blue-600">Analytics</span>
              </h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={fetchAllData} disabled={refreshing} className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white text-[13px] font-semibold px-4 py-2 rounded-lg transition-colors shadow-sm disabled:opacity-50">
            ...
            <div className="lg:col-span-8 flex flex-col gap-4">
              ...
              <Card className="p-4 md:p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-2">
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                    <p className="text-[20px] md:text-[24px] font-black text-blue-600 leading-none">{placementRate}%</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="p-4 md:p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4 mt-2">
                    <StatusBadge count={jobStats.active} label="Active" dotColor="bg-blue-500" bg="bg-white" textColor="text-gray-900" borderColor="border-gray-100 shadow-sm" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {packageStats.maxPackage > 0 ? (
                  <Card className="p-4 md:p-5">
                    ...
                    <div className="grid grid-cols-1 gap-3 mt-2">
                      <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-center justify-between">
                        <div>
                          <p className="text-[11px] font-bold text-gray-500 uppercase">Highest</p>
                      ...
                      <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-center justify-between">
                        <div>
                          <p className="text-[11px] font-bold text-gray-500 uppercase">Average</p>
                          <p className="text-[18px] font-black text-blue-600 mt-1">₹{packageStats.avgPackage.toFixed(1)}L</p>
                        </div>
                        <TrendingUp className="w-6 h-6 text-blue-200" />
                      </div>
                      <div className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex items-center justify-between">
                        <div>
                          <p className="text-[11px] font-bold text-gray-500 uppercase">Lowest</p>
                  ...
                  <Card className="p-4 md:p-5 flex flex-col items-center justify-center text-gray-400">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              ...
              <Card className="p-4 md:p-5">
                ...
                <div className="flex items-center gap-4 mb-5 mt-2">
                  ...
                  <div>
                    <p className="text-[13px] font-bold text-gray-800">Placement Rate</p>
                ...
                <div className="space-y-0 text-[13px]">
                  {[
                    { label: 'Total Students', value: overviewStats.totalStudents, col: 'text-blue-600' },
                    ...
                    {companyStats.slice(0, 6).map((comp, idx) => {
                      ...
                      return (
                        <div key={idx} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                          ...
                          <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-700 flex items-center justify-center text-[10px] font-black flex-shrink-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="w-full bg-gray-100 h-1.5 rounded-full mt-1.5">
                              <div className="h-full bg-blue-500 rounded-full" style={{ width: `${pct(count, maxCompany)}%` }} />
                            </div>
                          </div>
              ...
              <Card className="p-4 md:p-5">
                ...
                <div className="grid grid-cols-1 gap-2 mt-2">
                  <button onClick={() => navigate('/dashboard/college-admin/jobs')} className="w-full px-4 py-3 bg-blue-50 hover:bg-blue-100 text-blue-700 text-[13px] font-bold rounded-xl transition-colors flex items-center justify-center gap-2">
                    <Briefcase className="w-4 h-4" /> Manage Job Drives
                  </button>
                  <button onClick={() => navigate('/dashboard/college-admin/applications')} className="w-full px-4 py-3 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 text-[13px] font-bold rounded-xl transition-colors flex items-center justify-center gap-2">
