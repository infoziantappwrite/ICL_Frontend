    ...
    <CollegeAdminLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 bg-blue-50 border border-blue-100 rounded-2xl flex items-center justify-center flex-shrink-0 mt-1 shadow-sm">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <span className="inline-flex items-center gap-1 bg-blue-50 text-blue-700 rounded-md px-2 py-0.5 text-[11px] font-bold border border-blue-200 shadow-sm">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 flex-wrap">
          <button onClick={handleToggleStatus}
            className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-gray-700 text-[13px] font-bold px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
            {company.isActive ? <ToggleRight className="w-4 h-4 text-emerald-500" /> : <ToggleLeft className="w-4 h-4 text-gray-400" />}
          ...
          <div className="bg-white rounded-xl shadow-[0_1px_4px_rgba(0,0,0,0.06)] border border-gray-100 overflow-hidden">
            <div className="px-5 py-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
              ...
              <button onClick={() => navigate(`/dashboard/college-admin/jobs/create?companyId=${companyId}`)}
                className="inline-flex items-center gap-1 bg-white border border-gray-200 text-gray-700 text-[13px] font-bold px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                            <h4 className="text-[15px] font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{job.title}</h4>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-[14px] font-bold text-blue-800">JD Breakdown</p>
                </div>
                <div className="space-y-2">
                  {['Active', 'Draft', 'Closed', 'Cancelled'].map((status) => {
                    ...
                    return (
                      <div key={status} className="flex justify-between items-center">
                        <span className="text-blue-700 text-[12px] font-bold">{status}</span>
                        <span className="font-black text-blue-800 text-[15px]">{count}</span>
                      </div>
                    );
                  })}
                  <div className="border-t border-blue-200 mt-2 pt-3 flex justify-between items-center">
                    <span className="text-blue-700 text-[12px] font-bold">Total Eligible Students</span>
                    <span className="font-black text-blue-800 text-[18px]">{totalEligibleAcrossJDs}</span>
                  </div>
                </div>
              </div>
            </div>
