...
<div className="hidden md:block md:col-span-3 md:sticky md:top-[100px] self-start space-y-5">
            {/* Filter card */}
...
<p className="sm:hidden text-[12px] text-gray-500">
              {filteredAssessments.length} {filteredAssessments.length === 1 ? 'assessment' : 'assessments'} available
</p>
...
<button onClick={fetchAssessments} className="text-[12px] text-red-700 underline font-medium flex-shrink-0">
                  Retry
</button>
</div>
            )}
