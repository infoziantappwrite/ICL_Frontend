...
const CollegeDetail = () => {
  ...
  const fetchCollegeDetails = async () => {
    try {
      ...
      if (data.success) {
        console.log('📥 Fetched college data:', data.college);
        console.log('📋 Placement Config:', data.college.placementConfig);
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex gap-3">
                <button
                  onClick={() =>
                    navigate(`/dashboard/super-admin/colleges/${collegeId}/edit`)
                  }
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{college.phone}</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {college.placementConfig?.academicYear || 'Not Set'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {college.placementConfig?.minimumCGPA ?? 6.0}
                </p>
              </div>
              ...
              {(college.placementConfig?.allowBacklogs ?? true) && (
                <div>
                  ...
                  <p className="text-gray-900 font-medium">
                    {college.placementConfig?.maxBacklogsAllowed ?? 3}
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-3">
              <button
                onClick={() =>
                  navigate(
                    `/dashboard/super-admin/colleges/${collegeId}/admins/new`
                  )
                }
                className="w-full flex items-center gap-3 px-4 py-3 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 transition-colors font-medium"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 bg-green-50 text-green-700 rounded-xl hover:bg-green-100 transition-colors font-medium"
              >
                <Edit className="w-5 h-5" />
                Edit College
              </button>
              ...
              <button
                onClick={handleDelete}
                className="w-full flex items-center gap-3 px-4 py-3 bg-red-50 text-red-700 rounded-xl hover:bg-red-100 transition-colors font-medium"
              >
                <Trash2 className="w-5 h-5" />
                Delete College
              </button>
